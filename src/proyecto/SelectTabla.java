...
public class SelectTabla extends JFrame implements WindowListener, ActionListener, MouseListener {
	...
	public SelectTabla() {
		...
		lblSeleccionarTabla.setBounds(167, 28, 93, 14);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == btnAnimes) {
			...
			dispose();
			Tablas tr = new Tablas("Recomendaciones");
			...
			try {
				...
				if(rs.next()) {
					dispose();
					Tablas ti = new Tablas("Incorporaciones");
				}else {
					
					JOptionPane.showMessageDialog(null, "No hay incurporaciones en este momento",
